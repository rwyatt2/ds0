class DS0Checkbox extends HTMLElement {
    ...
    private addEventListeners(): void { this.shadowRoot?.addEventListener('click', this.handleClick); this.shadowRoot?.addEventListener('keydown', this.handleKeyDown); }
    private removeEventListeners(): void { this.shadowRoot?.removeEventListener('click', this.handleClick); this.shadowRoot?.removeEventListener('keydown', this.handleKeyDown); }
