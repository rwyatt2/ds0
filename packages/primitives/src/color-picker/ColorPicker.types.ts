...
export interface ColorPickerProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onChange'> { value?: string; defaultValue?: string; onChange?: (color: string) => void; format?: 'hex' | 'rgb' | 'hsl'; showAlpha?: boolean; swatches?: string[]; isDisabled?: boolean; }
