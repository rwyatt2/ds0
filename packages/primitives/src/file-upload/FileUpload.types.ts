...
export interface UseFileUploadReturn { dropzoneProps: React.HTMLAttributes<HTMLDivElement>; inputProps: React.InputHTMLAttributes<HTMLInputElement> & { ref: React.RefObject<HTMLInputElement> }; files: File[]; isDragOver: boolean; addFiles: (files: FileList | File[]) => void; removeFile: (index: number) => void; openFileBrowser: () => void; errors: string[]; }
